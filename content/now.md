...
- Trying to build a Voxel Engine using [Bevy][bevy] and Rust.
- Playing with pixel art and pencil drawing.
- Reading **Santo Guerreiro: Roma Invicta** and **Rust for rustaceans**.
